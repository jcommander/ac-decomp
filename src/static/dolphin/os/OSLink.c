...
#define __OSModuleInfoList AT_ADDRESS_STRUCT(OSModuleQueue, OS_BASE_CACHED | 0x30C8)
...
BOOL OSLink(OSModuleInfo* newModule, void* bss) {
    ...
    if (newModule->version > 2 ||
        (newModule->version >= 2 && ((moduleHeader->align && (u32)newModule % moduleHeader->align != 0) ||
